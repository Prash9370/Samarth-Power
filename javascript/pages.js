...
function loadlistpg(listnm, actv) {
    ...
    let htmldata = ``;
    switch (listnm) {
        case "weeder": htmldata = `<p class="listheading">Power Weeders</p>
        <div class="listcontainer">
            ...
            break;
        case "tiller": htmldata = `<p class="listheading">Rear Tillers</p>
        <div class="listcontainer">
            ...
            break;
        case "attachment": htmldata = `<p class="listheading">Weeder Attachments</p>
        <div class="listcontainer">
            ...
            break;
        case "tool": htmldata = `<!-- Brush Cutters -->
...
window.onload = function () {
    ...
    switch (section) {
        case ("view"): loadviewpg(param1, actv);
            break;
        case ("list"): loadlistpg(param1, actv);
            break;
    }
};